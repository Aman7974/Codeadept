        ...
        <Row>
          <Col size={12}>
            ...
            <div className="timeline-container">
              ...
              <div className="timeline-item">
                <div className="timeline-date">15 Nov 2024</div>
                <div className="timeline-event">
                  <h3>Mock Test</h3>
              ...
              <div className="timeline-item">
                <div className="timeline-date">Nov 16, 2024</div>
                <div className="timeline-event">
                  <h3>ROUND 1</h3>
              ...
              <div className="timeline-item">
                <div className="timeline-date">17 Nov 2022</div>
                <div className="timeline-event">
                  <h3>ROUND 2</h3>
              ...
              <div className="timeline-item">
                <div className="timeline-date">19 Nov 2024</div>
                <div className="timeline-event">
                  <h3>ROUND 3</h3>
